...
export default function MobileDashboard() {
  ...
  useEffect(() => {
    ...
    if (storedUserData) {
      ...
      // You might want to update weightData here if it's stored in localStorage
    }
  }, [])
  ...
  const renderDashboard = () => (
    <>
      ...
      <h2 className="text-xl font-bold mb-4 text-white">Your Workout Plan: {userData.workoutPlan}</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 to-indigo-900 text-white p-4 overflow-y-auto">
      <header className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">Hi, {userData.name || user?.displayName || 'User'}!</h1>
        ...
        <Card className="bg-white/10 shadow-xl mb-6">
          <CardContent className="p-4">
            ...
            <div className="space-y-2 text-white">
              ...
              <p><strong>Workout Plan:</strong> {userData.workoutPlan}</p>
              <p><strong>Program Duration:</strong> {userData.workoutDuration} weeks</p>
            </div>
